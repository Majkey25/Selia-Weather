...
dependencies {
    ...
    compileOnly("com.android.billingclient:billing-ktx:9.1.0")
    compileOnly("com.google.android.gms:play-services-ads:25.4.0")
    compileOnly("com.google.android.ump:user-messaging-platform:4.0.0")
    debugImplementation("com.android.billingclient:billing-ktx:9.1.0")
    debugImplementation("com.google.android.gms:play-services-ads:25.4.0")
    debugImplementation("com.google.android.ump:user-messaging-platform:4.0.0")
