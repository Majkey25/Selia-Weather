...
- Added a horizontal 20-hour outlook with temperature and precipitation information.
- Expanded the 14-day rows and kept the full hourly detail for each day.
- Added favourites, Czech place search, optional current location, offline cache, and the local ČHMÚ radar viewer.
...
The app remains an independent client for Czech weather data. It does not claim official ČHMÚ affiliation. It does not add ads, tracking, analytics, accounts, payment SDKs, or support entitlements.
